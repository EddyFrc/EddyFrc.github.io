  ...
  <main>
    ...
    <article class="details-succes" id="sloubi">
      <div>
        ...
        <p>
          L'objectif du projet était de réaliser un jeu d'arcade en Python en utilisant les librairies fournies par la
          calculatrice Numworks. J'ai d'abord utilisé l'éditeur en ligne sur le site officiel, puis j'ai utilisé les
          ...
          calculatrice sous forme d'une fenêtre sur le bureau d'un PC. Ainsi, j'ai pu utiliser un IDE pour gagner en
    ...
    <article class="details-succes" id="s2-01256">
      <div>
        ...
        <p>Période : Deuxième semestre du <abbr title="Bachelor Universitaire de Technologie">BUT</abbr> informatique
        </p>
        <h3>Planifier, concevoir et développer une application de bureautique complète à destination de professionnels
        </h3>
        <p>
          Le projet consiste à développer une application de bureau qui permet à un organisateur de marchés, brocantes,
          marchés de Noël de simplifier son organisation. L’utilisateur peut ainsi gérer les différents aspects de son
          événement dans une interface graphique. Le logiciel est adapté pour des professionnels qui doivent faire le
    ...
    <article class="details-succes" id="s1-012">
      <div>
        ...
        <p>
          L'objectif du projet était de réaliser un programme permettant de trier automatiquement des dépêches dans des
          catégories données. Pour cela, nous avons réparti les tâches pour gagner en productivité totale. Nous avons
          tous utilisé des <abbr title="Environnements de Développement Intégrés">IDE</abbr> (intelliJ et Visual Studio
          Code) pour écrire le code source en langage Java.
          De manière individuelle, chaque membre de l'équipe a travaillé sur une partie du code source et des données
          nécessaires au fonctionnement du programme. Au départ, je me suis principalement concentré sur la création
          manuelle de lexiques (ceux utilisés par l'algorithme pour classer les dépêches) et le programme principal, qui
          utilise l'ensemble des méthodes utilitaires pour fournir le résultat. J'ai aussi ajouté les touches finales
          telles qu'une légère optimisation des algorithmes, un formatage du code, l'ajout d'une documentation intégrée.
        </p>
      </div>
    ...
    <article class="details-succes" id="s1-03">
      <div>
        ...
        <p>
          La tâche donnée était de créer un guide d'installation du système d'exploitation GNU/Linux sur une machine
          virtuelle, puis des logiciels qui permettent de constituer un environnement de développement complet. J'ai
          configuré les options pendant l'installation pour personnaliser le système selon des indications spécifiques.
          J'ai utilisé des outils en ligne de commande sur un terminal, le tout dans un environnement bash.<br>
          J'ai ainsi réalisé une carte mentale qui indique les étapes, éléments à prendre en compte afin d'obtenir le
          même résultat. J'ai ajouté des "trucs et astuces" dans la carte mentale pour que le lecteur potentiel puisse
    ...
    <article class="details-succes" id="s1-04">
      <div>
        ...
        <p>
          L'objectif était de créer une base de données portant sur le naufrage du Titanic, à des fins d'analyse. Pour
          cela, nous avons réparti équitablement la quantité de travail pour chaque type de tâche. Ainsi, j'ai récupéré
          et compilé des informations trouvées sur internet afin de valider la viabilité et l'utilité d'une telle base
          de données. Puis, j'ai réalisé un schéma représentant la structures des données à analyser. Enfin et à l'aide
